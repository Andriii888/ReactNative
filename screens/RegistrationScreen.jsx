...
export const RegistrationScreen = () => {
  ...
  const [userRegisterState, setUserRegisterState] = useState(userInitialState);
  ...
  const onSubmitBtn = () => {
    ...
    setUserRegisterState(userInitialState);
  };
  return (
    <View
      style={{
      ...
      >
        ...
        <View style={styles.form}>
          <View style={styles.inputBox}>
            <TextInput
              onChangeText={(value) =>
                setUserRegisterState((prevState) => ({
                  ...prevState,
                  login: value,
                }))
              }
              value={userRegisterState.login}
              style={styles.input}
              placeholder="Login"
              onFocus={onFocus}
            ></TextInput>
